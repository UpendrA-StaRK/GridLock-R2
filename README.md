...
- **Windows**: Run `scripts\run_project.bat`
- **Linux/Mac**: Run `bash scripts/run_project.sh`
...
3. Run the inference-only scripts:
   - **Windows**: Run `scripts\run_inference_only.bat`
   - **Linux/Mac**: Run `bash scripts/run_inference_only.sh`
