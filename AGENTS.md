# AGENTS.md — ML Hackathon Project
...
- When a new model is loaded, it MUST read this entire AGENTS.md before doing anything.
...
[2026-06-16] [Codex Sonnet 4.6 Thinking] [STEP: EDA/pre-architecture] Full EDA audit complete. 298,450 rows. Split viable (train=226k, test=70k). data_sent_to_scita_timestamp excluded (leakage). violation_type is JSON-list string. Duplicates = multi-violation events (dedup only if ALL fields identical). CIS + ranker formulas versioned. eda_summary.json saved. 4 config gates remain open.
...
[2026-06-19] [Gemini 3.5 Flash] [STEP: DBSCAN Memory Fix] Fixed MemoryError: bad allocation during grid search by changing DBSCAN n_jobs from -1 to None (single-threaded) in src/models/clustering.py.[ 2 0 2 6 - 0 6 - 2 1 ]   [ A n t i g r a v i t y ]   [ S T E P :   F u l l   P i p e l i n e   R e r u n ]   R e t r a i n e d   m o d e l s   a n d   r a n   i n f e r e n c e .   L i g h t G B M _ h o u r   o v e r t o o k   t h e   l e a d e r b o a r d   w i t h   M A E = 4 . 3 0 6 4   a n d   R M S E = 1 0 . 0 6 9 4 .   U p d a t e d   m e t r i c s   a c r o s s   p r o j e c t   d o c u m e n t a t i o n .  
 